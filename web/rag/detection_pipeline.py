    ...
    messages: List[Dict[str, str]] = [
        {
            ...
            "content": (
                ...
                "- Some Retrieved Documents are PDFs of historical chat transcripts from the same user.\n"
                "- Use those transcripts in your scoring.\n\n"
                "Rules:\n"
                "1) You may use general medical knowledge for context, BUT the 5-category mapping should follow the dataset/rubric "
